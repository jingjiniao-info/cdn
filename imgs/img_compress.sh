...
#设置图片绝对路径
imgpath='/www/wwwroot/jingjiniao.info/data/attachment/forum'
...
function com_img(){
	...
	#使用jpegoptim压缩.jpg
	find $1 -mmin -60 -size +$2 -name '*.jpg' -exec jpegoptim -m 70 {} \;
	find $1 -mmin -60 -size +$2 -name '*.jpeg' -exec jpegoptim -m 70 {} \;
}
